...
export const PortfolioDetail: React.FC = () => {
  ...
  if (!category) {
    return (
      <>
        <Helmet>
          <title>Portfolio category not found - TechReign Digital Studio</title>
          {/* No canonical to the homepage here: that told Google this 404 page
              was the homepage. An unknown slug is simply not indexable. */}
  ...
  return (
    <>
      <Seo path={`/portfolio/${projectSlug}`} />
      <Helmet>
