...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    ...
    >
      <article className="relative flex h-full flex-col justify-between overflow-hidden rounded-[32px] border border-white/12 bg-gradient-to-br from-white/12 via-transparent to-white/5 p-card shadow-floating ring-1 ring-white/5 transition hover:-translate-y-1 hover:bg-gradient-to-br hover:from-white/24 hover:via-white/10">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm leading-relaxed text-white/80 line-clamp-4">"{quote}"</p>
        </div>
        <div className="relative z-10 mt-5 flex items-center justify-between">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 opacity-0 transition group-hover:opacity-100">
            <ArrowUpRight size={16} className="text-white/70 transition group-hover:text-white" />
          </div>
        </div>
      </article>
    </a>
